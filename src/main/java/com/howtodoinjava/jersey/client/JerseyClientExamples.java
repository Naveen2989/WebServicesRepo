...
public class JerseyClientExamples 
{
	...
	private static void httpGETCollectionExample() 
	{
		...
		WebTarget webTarget = client.target("http://localhost:8085/JerseyDemos/rest").path("employees");
	...
	private static void httpGETEntityExample() 
	{
		...
		WebTarget webTarget = client.target("http://localhost:8085/JerseyDemos/rest").path("employees").path("1");
